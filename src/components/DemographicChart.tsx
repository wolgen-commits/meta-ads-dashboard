    ...
    <div className="chart-card">
      <div style={{ marginBottom: 8 }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 10, fontSize: 11, fontFamily: "DM Sans", color: tickColor }}>
          <span>Total: <strong style={{ color: "var(--gray-900)" }}>{num(totalAll)}</strong></span>
          <span>·</span>
        ...
        <div style={{ fontSize: 10, color: "#A1A1AA", marginTop: 3 }}>
          * Data breakdown demografis hanya mencakup periode yang telah di-backfill — total bisa lebih kecil dari ringkasan keseluruhan
        </div>
      </div>
